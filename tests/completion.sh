...
try 'jroot clone '                    'checkpoint'
try 'jroot clone checkpoint '         'dev'
try 'jroot clone checkpoint dev '     'baseline'
try 'jroot clone snapshot dev '       'before-test'
